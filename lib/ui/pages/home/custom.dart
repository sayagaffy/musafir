// ignore_for_file: no_leading_underscores_for_local_identifiers, prefer_const_constructors, prefer_const_literals_to_create_immutables, curly_braces_in_flow_control_structures, sort_child_properties_last
...
class DropDownCust extends StatefulWidget {
  const DropDownCust({super.key});

  @override
  State<DropDownCust> createState() => _DropDownCustState();
}
...
class _DropDownCustState extends State<DropDownCust> {
            ...
            children: <Widget>[
              ...
              Row(
                children: [
                  ...
                  Padding(padding: EdgeInsets.all(4)),
                  Expanded(
                    child: DropdownSearch<UserMode>.multiSelection(
                      asyncItems: (filter) => getData(filter),
                      compareFn: (i, s) => i.isEqual(s),
                      popupProps: PopupPropsMultiSelection.modalBottomSheet(
                        showSearchBox: true,
  ...
  Widget _customDropDownExampleMultiSelection(
      BuildContext context, List<UserMode> selectedItems) {
  ...
  Widget _customPopupItemBuilderExample2(
      BuildContext context, UserMode item, bool isSelected) {
    return Container(
